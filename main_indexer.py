...
def main():
    ...
    for doc_id, url, content, encoding in data_loader_instance.iter_documents():
        ...
        normal_text, important_text = parser_instance.extract_text(content)
        token_weight_pairs = tokenizer_instance.tokenize_normal_and_important(
            normal_text, important_text
        )
